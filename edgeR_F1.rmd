...
load("phasedData.Rdata") # This is the annotated data from MBASED analysis. It has already gone through SNP calling 
...
save(reads_subset, file = "edgeRReadsSubset.Rdata")
```
...
youngDEGenes_subset <- topTags(youngLRT,n = Inf)$table[topTags(youngLRT,n = Inf)$table$FDR<0.05,]

save(youngDEGenes_subset, file = "youngDEGenes_subset.Rdata")
