...
kal_dirs <- file.path("results", sample_id, "kallisto") # This line was used for sleuth with all the genes
# kal_dirs <- file.path("results_subset", sample_id, "kallisto") # This line was used for sleuth with a subset of the genes
kal_dirs
