...
cis_eQTL <- cis_eQTL[, c(1, 3, 5, 6)]
colnames(cis_eQTL) <- c("trait", "CHROM", "START", "END")

eQTLgenes <- ExtracteQTLgenes(trans_eQTL, gff.mRNA)
ciseQTLgenes <- ExtracteQTLgenes(cis_eQTL, gff.mRNA)

summary(intersect(aseGenesBeta, eQTLgenes))
