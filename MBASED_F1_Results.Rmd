...
genesDiffASEBinom <- union(genes, genesRev) # All the genes 
genesDiffASEBeta <- union(genesb, genesRevb) # All the genes 
matchesBetweenBetaAndBinomial <- intersect(total, totalb)

save(genesDiffASEBeta, file = "genesDiffASEBeta.Rdata")
```