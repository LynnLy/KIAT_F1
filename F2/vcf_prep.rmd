...
save(vcfTidy, file = "tidy_vcf/vcfTidy.Rdata")

finalCalls <- read.table("input/F2_Final_SNP_Calls", header = TRUE)

aseRatiosF2 <- vcfTidy2ASE(vcfTidy, finalCalls)
...
summary(aseRatiosF2$GT) # 1246299 are heterozygous

aseRatiosF2 <- aseRatiosF2 %>% filter(GT == "0/1")
